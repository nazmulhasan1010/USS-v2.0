...
<footer class="style-1">
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-lg-4">
                    <div class="foot_subscribe">
                        ...
                        <p class="fst-italic">By subscribing, you accepted the our <a href="#" class="text-decoration-underline"> Policy</a></p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <img src="{{asset('assets/img/footer/foot_l.png')}}" alt="" class="foot_l">
    <img src="{{asset('assets/img/footer/foot_r.png')}}" alt="" class="foot_r">
</footer>
<!-- ====== end footer ====== -->
