            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="service-box mb-4 wow fadeInUp" data-wow-delay="0.2s">
                        ...
                        <div class="icon">
                            <img src="{{asset('')}}assets/img/icons/serv_icons/2.png" alt="">
                        </div>
                        <div class="info">
                            <div class="text">
                                Trust our top minds to eliminate workflow pain points, implement new tech & app.
                ...
                <div class="col-lg-4">
                    <div class="service-box mb-4 mb-md-0 wow fadeInUp" data-wow-delay="0">
                        ...
                        <div class="icon">
                            <img src="{{asset('')}}assets/img/icons/serv_icons/4.png" alt="">
                        </div>
                        <div class="info">
                            <div class="text">
                                Trust our top minds to eliminate workflow pain points, implement new tech & app.
...
{{--            </div>--}}
    ...
    <img src="{{asset('')}}assets/img/services/ser_shap_r.png" alt="" class="ser_shap_r">
</section>
<!-- ====== end services ====== -->
