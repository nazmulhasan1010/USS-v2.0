                            ...
                            <div class="swiper-slide">
                                <div class="content-card">
                                    <div class="img overlay">
                                        <img src="{{asset('')}}assets/img/blog/s_blog.png" alt="">
                                    </div>
                                    <div class="info">
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="cont">
                                                    ...
                                                    <h2 class="title">
                                                        <a href="{{route('post')}}">Solutions For Big Data Issue, Expert Perspective</a>
                                                    </h2>
            ...
            <div class="container">
                ...
                <div class="row gx-5">
                    <div class="col-lg-4 border-end brd-gray">
                        <div class="card border-0 bg-transparent rounded-0 mb-30 mb-lg-0 d-block">
                            <div class="img radius-7 overflow-hidden img-cover">
                                <img src="{{asset('')}}assets/img/blog/1.jpg" class="card-img-top" alt="...">
                            </div>
                    ...
                    <div class="col-lg-4 border-end brd-gray">
                        <div class="card border-0 bg-transparent rounded-0 mb-30 mb-lg-0 d-block">
                            <div class="img radius-7 overflow-hidden img-cover">
                                <img src="{{asset('')}}assets/img/blog/7.png" class="card-img-top" alt="...">
                            </div>
                            <div class="card-body px-0">
                                <small class="d-block date mt-10 fs-10px fw-bold">
                                    <a href="#" class="text-uppercase border-end brd-gray pe-3 me-3 color-blue5">News</a>
                    ...
                    <div class="col-lg-4">
                        <div class="card border-0 bg-transparent rounded-0 mb-30 mb-lg-0 d-block">
                            <div class="img radius-7 overflow-hidden img-cover">
                                <img src="{{asset('')}}assets/img/blog/5.png" class="card-img-top" alt="...">
                            </div>
                            <div class="card-body px-0">
                                <small class="d-block date mt-10 fs-10px fw-bold">
                                    <a href="#" class="text-uppercase border-end brd-gray pe-3 me-3 color-blue5">News</a>
                    ...
                    <div class="col-lg-8">
                            ...
                            <div class="row">
                                <div class="col-lg-5">
                                    <div class="img img-cover">
                                        <img src="{{asset('')}}assets/img/blog/6.png" class="radius-7" alt="...">
                                    </div>
                                </div>
                                <div class="col-lg-7">
                        ...
                        <div class="card border-0 bg-transparent rounded-0 border-bottom brd-gray pb-30 mb-30">
                            <div class="row">
                                <div class="col-lg-5">
                                    <div class="img img-cover">
                                        <img src="{{asset('')}}assets/img/blog/4.jpg" class="radius-7" alt="...">
                                    </div>
                                </div>
                                <div class="col-lg-7">
                                    <div class="card-body p-0">
                        ...
                        <div class="card border-0 bg-transparent rounded-0 border-bottom brd-gray pb-30 mb-30">
                            <div class="row">
                                <div class="col-lg-5">
                                    <div class="img img-cover">
                                        <img src="{{asset('')}}assets/img/blog/10.png" class="radius-7" alt="...">
                                    </div>
                                </div>
                                <div class="col-lg-7">
                                    <div class="card-body p-0">
                        ...
                        <div class="card border-0 bg-transparent rounded-0 border-bottom brd-gray pb-30 mb-30">
                            <div class="row">
                                <div class="col-lg-5">
                                    <div class="img img-cover">
                                        <img src="{{asset('')}}assets/img/blog/11.png" class="radius-7" alt="...">
                                    </div>
                                </div>
                                <div class="col-lg-7">
                                    <div class="card-body p-0">
                        ...
                        <div class="card border-0 bg-transparent rounded-0 border-bottom brd-gray pb-30 mb-30">
                            <div class="row">
                                <div class="col-lg-5">
                                    <div class="img img-cover">
                                        <img src="{{asset('')}}assets/img/blog/9.png" class="radius-7" alt="...">
                                    </div>
                                </div>
                                <div class="col-lg-7">
                                    <div class="card-body p-0">
                        ...
                        <div class="card border-0 bg-transparent rounded-0 border-bottom brd-gray pb-30 mb-30">
                            <div class="row">
                                <div class="col-lg-5">
                                    <div class="img img-cover">
                                        <img src="{{asset('')}}assets/img/blog/3.jpg" class="radius-7" alt="...">
                                    </div>
                                </div>
                                <div class="col-lg-7">
                                    <div class="card-body p-0">
                        ...
                        <div class="card border-0 bg-transparent rounded-0 pb-30 mb-30 mb-lg-0 pb-lg-0">
                            <div class="row">
                                <div class="col-lg-5">
                                    <div class="img img-cover">
                                        <img src="{{asset('')}}assets/img/blog/12.png" class="radius-7" alt="...">
                                    </div>
                                </div>
                                <div class="col-lg-7">
                                    <div class="card-body p-0">
                        ...
                        <div class="side-blog style-5 ps-lg-5 mt-5 mt-lg-0">
                            ...
                            <div class="side-recent-post mb-50">
                                ...
                                <a href="page-single-post-5.html" class="post-card">
                                    <div class="img me-3">
                                        <img src="{{asset('')}}assets/img/blog/7.png" alt="">
                                    </div>
                                    <div class="inf">
                            ...
                            <div class="side-insta mb-50">
                                ...
                                <div class="d-flex justify-content-between flex-wrap">
                                    <a href="{{asset('')}}assets/img/blog/1.jpg" class="insta-img img-cover" data-fancybox="gallery">
                                        <img src="{{asset('')}}assets/img/blog/1.jpg" alt="">
                                        <i class="fab fa-instagram icon"></i>
                                    </a>
                                    <a href="{{asset('')}}assets/img/blog/10.png" class="insta-img img-cover" data-fancybox="gallery">
                                        <img src="{{asset('')}}assets/img/blog/10.png" alt="">
                                        <i class="fab fa-instagram icon"></i>
                                    </a>
                                    <a href="{{asset('')}}assets/img/blog/11.png" class="insta-img img-cover" data-fancybox="gallery">
                                        <img src="{{asset('')}}assets/img/blog/11.png" alt="">
                                        <i class="fab fa-instagram icon"></i>
                                    </a>
                                    <a href="{{asset('')}}assets/img/blog/12.png" class="insta-img img-cover" data-fancybox="gallery">
                                        <img src="{{asset('')}}assets/img/blog/12.png" alt="">
                                        <i class="fab fa-instagram icon"></i>
                                    </a>
                                    <a href="{{asset('')}}assets/img/blog/2.jpg" class="insta-img img-cover" data-fancybox="gallery">
                                        <img src="{{asset('')}}assets/img/blog/2.jpg" alt="">
                                        <i class="fab fa-instagram icon"></i>
                                    </a>
                                    <a href="{{asset('')}}assets/img/blog/3.jpg" class="insta-img img-cover" data-fancybox="gallery">
                                        <img src="{{asset('')}}assets/img/blog/3.jpg" alt="">
                                        <i class="fab fa-instagram icon"></i>
                                    </a>
                                </div>
